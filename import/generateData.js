...
async function viderCollectionActions() {
  ...
  try {
    ...
    console.error(
      "Erreur lors de la suppression des documents de la collection 'actions': ",
      error
    );
  }
}
...
async function viderCollectionStats() {
  ...
  try {
    ...
    console.error(
      "Erreur lors de la suppression des documents de la collection 'stats': ",
      error
    );
  }
}
...
async function viderCollectionChallenges() {
  ...
  try {
    ...
    console.error(
      "Erreur lors de la suppression des documents de la collection 'challenges': ",
      error
    );
  }
}
...
async function viderCollectionBadges() {
  ...
  try {
    ...
    console.error(
      "Erreur lors de la suppression des documents de la collection 'badges': ",
      error
    );
  }
}
...
async function ajouterUtilisateur(uid) {
  ...
  const connectionHistory = Array.from({ length: 10 }, () =>
    generateRandomDate()
  )
    .map(formatDate)
    .sort((a, b) => {
  ...
  try {
    ...
    console.log(
      `Utilisateur ajouté avec succès avec l'identifiant : ${docRef.id}`
    );
    return docRef.id;
  } catch (error) {
...
function randomAction(uid) {
  const actionDataFood1 = createActionData(
    uid,
    "food",
    "coffee",
    null,
  ...
  const actionDataFood2 = createActionData(
    uid,
    "food",
    "drinks",
    "Eau en bouteille",
  ...
  const actionDataTransport1 = createActionData(
    uid,
    "transport",
    "car",
    "Thermique",
  ...
  const actionDataTransport2 = createActionData(
    uid,
    "transport",
    "train",
    "Transilien",
  ...
  const actionDataClothes1 = createActionData(
    uid,
    "clothes",
    "Chemise",
    "Coton",
  ...
  const actionDataClothes2 = createActionData(
    uid,
    "clothes",
    "Manteau",
    "Veste imperméable",
  ...
  const actionDataEnergy1 = createActionData(
    uid,
    "lodging",
    "electricity",
    "Photovoltaïque",
  ...
  const actionDataEnergy2 = createActionData(
    uid,
    "lodging",
    "gas",
    "Gaz naturel",
  ...
  const actions = [
    actionDataFood1,
    actionDataFood2,
    actionDataTransport1,
    actionDataTransport2,
    actionDataClothes1,
    actionDataClothes2,
    actionDataEnergy1,
    actionDataEnergy2,
